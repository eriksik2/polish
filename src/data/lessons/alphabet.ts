  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          text: 'Tap any letter badge to hear native pronunciation. Use headphones if you can.',
        },
      ],
    },
    {
      ...
      popQuestions: [
        {
          id: 'vowels-letters',
          prompt: 'How many letters does the Polish alphabet have?',
          options: ['26', '30', '32', '36'],
          correctIndex: 2,
          explanation: 'Polish uses 32 letters, including nasal vowels and soft consonants.',
        },
        {
          id: 'vowels-o-sound',
          prompt: 'Polish O sounds most like which English vowel?',
          options: ['“oh” in go', '“aw” in caught', '“oo” in boot', '“a” in cat'],
          correctIndex: 1,
          explanation: 'Polish O is an open “aw”, not a tight English “oh”.',
        },
        {
          id: 'vowels-nasal',
          prompt: 'Ą and ę are called what kind of vowels?',
          options: ['Long vowels', 'Nasal vowels', 'Silent vowels', 'Diphthongs'],
          correctIndex: 1,
        },
        {
          id: 'vowels-ou',
          prompt: 'Ó and u represent the same sound in Polish.',
          options: ['True', 'False'],
          correctIndex: 0,
          explanation: 'Both spell the “oo” sound; spelling rules decide which letter to write.',
        },
        {
          id: 'vowels-y',
          prompt: 'After a consonant, Polish y sounds like…',
          options: ['English “y” in yes', 'Polish i (“ee”)', 'Polish u (“oo”)', 'It is silent'],
          correctIndex: 1,
        },
        {
          id: 'vowels-count',
          prompt: 'How many vowel letters does Polish have?',
          options: ['5', '7', '9', '11'],
          correctIndex: 2,
        },
      ],
    ...
    },
    {
      ...
      popQuestions: [
        {
          id: 'cons-aspiration',
          prompt: 'Compared with English, Polish consonants are usually…',
          options: ['More aspirated', 'Less aspirated', 'Exactly the same', 'Always voiced'],
          correctIndex: 1,
        },
        {
          id: 'cons-c',
          prompt: 'Polish C before e, i, or y sounds like…',
          options: ['“k” in cat', '“ts” in cats', '“ch” in church', '“s” in sun'],
          correctIndex: 1,
        },
        {
          id: 'cons-r',
          prompt: 'Polish R is typically…',
          options: ['Silent', 'A tapped or rolled R', 'Like English “r” in red', 'Like “w”'],
          correctIndex: 1,
        },
        {
          id: 'cons-digraphs',
          prompt: 'Two-letter spellings like ch and sz are covered in…',
          options: ['This section', 'The digraphs lesson', 'They do not exist', 'Only in loanwords'],
          correctIndex: 1,
        },
        {
          id: 'cons-count',
          prompt: 'This section focuses on consonants that are mostly familiar to English speakers.',
          options: ['True', 'False'],
          correctIndex: 0,
        },
      ],
    ...
    },
    {
      ...
      popQuestions: [
        {
          id: 'spec-l',
          prompt: 'Polish Ł sounds like…',
          options: ['English L', 'English W', 'English V', 'It is silent'],
          correctIndex: 1,
          explanation: 'Ł is a dark “w” — łódź starts with this sound, not L.',
        },
        {
          id: 'spec-w',
          prompt: 'Polish W sounds like…',
          options: ['English W', 'English V', 'English F', 'Polish Ł'],
          correctIndex: 1,
        },
        {
          id: 'spec-soft',
          prompt: 'Ć, ś, ź, and ń are described as…',
          options: ['Nasal consonants', 'Soft (palatalised) consonants', 'Silent letters', 'Vowels'],
          correctIndex: 1,
        },
        {
          id: 'spec-z',
          prompt: 'Ż is the hard “zh” sound (like vision).',
          options: ['True', 'False'],
          correctIndex: 0,
        },
        {
          id: 'spec-pairs',
          prompt: 'Soft ć, ś, ź pair with harder cousins taught in…',
          options: ['This section only', 'The digraphs lesson', 'English spelling rules', 'Nowhere'],
          correctIndex: 1,
        },
      ],
      practice: {
